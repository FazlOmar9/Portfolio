  ...
  const contactLinks = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/FazlOmar9",
    ...
    },
    {
      ...
      label: "fazlomr3@gmail.com",
      link: "mailto:fazlomar3@gmail.com",
      position: { top: "80%", left: "70%" },
    },
    {
      icon: <FileText className="w-6 h-6 text-white" />,
      label: "Resume",
      link: "https://drive.google.com/file/d/1JU-CBGYYv8s64NajiT6mEuyUhgomZuR4/view?usp=sharing",
...
const ContactItem = ({ icon, label, link, position }) => {
  ...
  return (
    ...
    >
      ...
      <span className="ml-2 text-white text-sm transition-opacity duration-200">{typedLabel}</span>
    </a>
  );
};
